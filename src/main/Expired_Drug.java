...
ResultSet res1 = null;
    ...
    private void show_table() { 
        String sql = "SELECT NAME, BARCODE, PRODUCTION_DATE, EXPIRATION_DATE, QUANTITY, EXPIRY " +
                     "FROM drugs " +
                     "WHERE DATEDIFF(EXPIRATION_DATE, CURDATE()) <= 0 ";
        String sql1 = "UPDATE drugs SET EXPIRY='Expired' WHERE DATEDIFF(EXPIRATION_DATE, CURDATE()) <= 0";
        try {
            pre1 = con.prepareStatement(sql1);
            pre1.executeUpdate(); // Execute the update statement
